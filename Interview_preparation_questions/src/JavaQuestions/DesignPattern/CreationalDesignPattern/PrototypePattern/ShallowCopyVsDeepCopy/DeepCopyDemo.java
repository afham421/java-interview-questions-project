package JavaQuestions.DesignPattern.CreationalDesignPattern.PrototypePattern.ShallowCopyVsDeepCopy;
...
class Person1 implements Cloneable {
    ...
    protected Person1 clone() throws CloneNotSupportedException {
        // Deep copy // means address class will be copied not its reference only
