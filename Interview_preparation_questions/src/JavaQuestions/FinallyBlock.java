...
//    Exception Threw but Not Caught: If an exception is thrown in the try block but is not caught (or is re-thrown), the finally block will execute before the exception propagates.
